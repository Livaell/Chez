...
var start = '<div id="msn"><table width="999" style="border-collapse: collapse; margin:auto"  cellpadding="0" cellspacing="0" border="0" ><tr><td class="MsoNormal" style="font-size:12.0pt;font-family:Microsoft Sans Serif; padding-left: 6pt"><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;"><tr><td width="600">ФГБУ Поволжская МИС - Аграрная информационная система МАТЧЭЗ</td><td id="ulin" width="399" align="right" valign="middle" style="font-size:9.0pt;font-family:Microsoft Sans Serif;padding-right:20px">Вы вошли как: User</td></tr></table></td></tr><tr><td height="30" style="background-image:url(http://cez.aist-agro.ru/image/tbg.png)"><table width="997" border="0" style="border-collapse:collapse;"><tr><td width="75px"><img id="mm1" class="cursor" src="http://cez.aist-agro.ru/image/m11.png" style="margin-left:15px; margin-top:3px" onmouseover="rm11(this)" onmouseout="rm12(this)" onclick="M()"/></td><td width="75px"><img id="mm2" class="cursor" src="http://cez.aist-agro.ru/image/m21.png" style="margin-top:3px" onmouseover="rm21(this)" onmouseout="rm22(this)" onclick="A()"/></td><td width="75px"><img id="mm3" class="cursor" src="http://cez.aist-agro.ru/image/m31.png" style="margin-top:3px" onmouseover="rm31(this)" onmouseout="rm32(this)" onclick="T()"/></td><td align="left"><img id="mm4" class="cursor" src="http://cez.aist-agro.ru/image/m41.png" style="margin-top:3px" onmouseover="rm41(this)" onmouseout="rm42(this)" onclick="frm()"/></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr></table></td></tr></table></div><table width="999" height="708" style="border-collapse: collapse; border-color: rgb(0,0,0);"  cellpadding="0" cellspacing="0" align="center" border="1" ><tr valign="top"><td width="208" style="background-color: rgb(242,242,241)"><div id="Pic" style="width:156pt"><img id="p1" src="http://cez.aist-agro.ru/image/Pic02.png" alt="Pic02" width="52" height="42" onclick="Pic1(this)" /><img id="p2" src="http://cez.aist-agro.ru/image/Pic13.png" alt="Pic13" width="52" height="42" onclick="Pic2(this)" /><img id="p3" src="http://cez.aist-agro.ru/image/Pic20.png" width="52" height="42" onclick="Pic3(this)" /><img id="p4" src="http://cez.aist-agro.ru/image/Pic30.png" width="52" height="42" onclick="Pic4(this)" /></div><p id="nl" style="padding: 7pt 5.4pt 9pt 11pt; ">Инструменты расчета</p><div id="Pi"><img src="http://cez.aist-agro.ru/image/Pi00.png" width="205" height="37" onclick="addrow()" onmouseover="f00a(this)" onmouseout="f00b(this)" /><img src="http://cez.aist-agro.ru/image/Pi10.png" width="205" height="37" onmouseover="f10a(this)" onmouseout="f10b(this)" onclick="prt()"/><img src="http://cez.aist-agro.ru/image/Pi20.png" width="205" height="37" onclick="DelRows()" onmouseover="f20a(this)" onmouseout="f20b(this)" /></div></td><td id="u" width="785" align="left" valign="top" bgcolor="#FFFFFF"><p style="padding: 0pt 9pt 0pt 33pt; ">Информационно-консультативная служба "МАШИНЫ"</p><div style="background-image:url(http://cez.aist-agro.ru/image/pn3.png); height:30pt; width:578pt; margin-left:6pt; padding-top:34pt"><table width="761" style="border-collapse: collapse; "cellpadding="0" cellspacing="0" border="0"><tr><td width="400"><select id="sp1" style="margin:0pt 0pt 0pt 8pt; width:415px" onchange="Cb1()"></select></td><td width="155"><select id="sp2" style="margin:0pt 0pt 0pt 8pt; width:111pt; width:150px"  onchange="Cb2()"  onfocus=""></select></td><td width="206"><select id="sp3" style="margin:0pt 0pt 0pt 8pt; width:150px; " ></select></td></tr></table></div><div id="Q" style="padding-bottom:7px;"><p style=" margin-top:100px;padding-left:27pt; font-family:Microsoft Sans Serif; font-size:16px">Начало работы</p><p style="padding-left:27pt; font-family:Microsoft Sans Serif; font-size:14px;"><font color="#0066CC">1. Сформируйте запрос на предоствление сведений по технике в панели выбора сельскохозяйственных машин </font></p><p style="padding-left:27pt; font-family:Microsoft Sans Serif; font-size:14px"><font color="#0066CC">2. Нажатие кнопки "Расчет" осуществляет отображение результатов </font></p><p style="padding-left:27pt; font-family:Microsoft Sans Serif; font-size:14px"><font color="#0066CC">3. В последующей работе с ИКС "Машины" руководствуйтесь подсказками и инструкциями </font></p></div></td></tr></table>'; // переменная хранения начальной страницы
	...
	$(function() {
		...
		$('#registerButton').bind('click',function(){validateSteps();
			if($('#formElem').data('errors')){
				...
				getAjax('http://cez.aist-agro.ru/register/reg.php?s=' + encodeURIComponent(m.join('|')), okreg);
...
function ent(s){
	...
	if(a[0] != ''){
		...
		document.body.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/fon.png")';
		...
		document.getElementById('ulin').innerHTML = '<table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse;"><tr align="right"><td>Вы вошли как:</td><td width="20px"><img src="http://cez.aist-agro.ru/image/iuser.png" width="16" height="16" /></td><td id="lin" align="left" style="padding-left:7px;padding-right:7px">' + a[1] + '</td><td width="20px"><img src="http://cez.aist-agro.ru/image/iuserout.png" width="16" height="16" onclick="window.location.reload()" title="Выход" class="cursor"/></td></tr></table>';
...
//Меню
function rm11(e){e.src = "http://cez.aist-agro.ru/image/m12.png"};function rm12(e){e.src = "http://cez.aist-agro.ru/image/m11.png"};function rm21(e){e.src = "http://cez.aist-agro.ru/image/m22.png"};function rm22(e){e.src = "http://cez.aist-agro.ru/image/m21.png"};function rm31(e){e.src = "http://cez.aist-agro.ru/image/m32.png"};function rm32(e){e.src = "http://cez.aist-agro.ru/image/m31.png"};function rm41(e){e.src = "http://cez.aist-agro.ru/image/m42.png"};function rm42(e){e.src = "http://cez.aist-agro.ru/image/m41.png"} //Смена иконок
function M(){
	...
	z = 'm'; document.getElementById('Pic').innerHTML = '<img id="p1" src="http://cez.aist-agro.ru/image/Pic02.png" width="52" height="42" onclick="Pic1(this)" /><img id="p2" src="http://cez.aist-agro.ru/image/Pic53.png" width="52" height="42" onclick="Pic2(this)" /><img id="p3" src="http://cez.aist-agro.ru/image/Pic20.png" width="52" height="42" onclick="Pic3(this)" /><img id="p4" src="http://cez.aist-agro.ru/image/Pic30.png" width="52" height="42" onclick="Pic4(this)" />'; Pic1();
...
function T(){z = 't';
	document.getElementById('Pic').innerHTML = '<img id="p1" src="http://cez.aist-agro.ru/image/Pic42.png" width="52" height="42" onclick="Pic5(this)" /><img id="p2" src="http://cez.aist-agro.ru/image/Pic53.png" width="52" height="42" onclick="Pic6(this)" /><img id="p3" src="http://cez.aist-agro.ru/image/Pic60.png" width="52" height="42" onclick="Pic7(this)" /><img id="p4" src="http://cez.aist-agro.ru/image/Pic70.png" width="52" height="42" onclick="Pic8(this)" />';
	Pic6();
...
function Pic1(e){//alert(e.alt);
	var q1 = document.getElementById('p1'); q1.src = "http://cez.aist-agro.ru/image/Pic02.png";
	var q2 = document.getElementById('p2');if(q2.src == 'http://cez.aist-agro.ru/image/Pic12.png'){pc2 = ReOne();}; q2.src = "http://cez.aist-agro.ru/image/Pic13.png";
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic20.png";
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic30.png";
	...
	t.innerHTML = pc1;
	t = document.getElementById('Pi');t.innerHTML = '<img src="http://cez.aist-agro.ru/image/Pi00.png" width="205" height="37" onclick="addrow()" onmouseover="f00a(this)" onmouseout="f00b(this)" /><img src="http://cez.aist-agro.ru/image/Pi10.png" width="205" height="37" onmouseover="f10a(this)" onmouseout="f10b(this)" onclick=""/><img src="http://cez.aist-agro.ru/image/Pi20.png" width="205" height="37" onclick="DelRows()" onmouseover="f20a(this)" onmouseout="f20b(this)"/>';
}//Инструменты пересчета
function Pic2(e){
	var q1 = document.getElementById('p1');if(q1.src == 'http://cez.aist-agro.ru/image/Pic02.png'){t = document.getElementById('u');pc1 = t.innerHTML;};q1.src = "http://cez.aist-agro.ru/image/Pic00.png";
	var q2 = document.getElementById('p2'); q2.src = "http://cez.aist-agro.ru/image/Pic12.png";
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic23.png";
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic30.png";
...
function Pic4(e){
	...
	var q2 = document.getElementById('p2');if(q2.src == 'http://cez.aist-agro.ru/image/Pic12.png'){pc2 = ReOne();}; q2.src = "http://cez.aist-agro.ru/image/Pic10.png"; 
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic20.png"; 
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic32.png";
...
function Pic6(e){
	var q1 = document.getElementById('p1');if(q1.src == 'http://cez.aist-agro.ru/image/Pic42.png'){t = document.getElementById('u');pc5 = t.innerHTML;};q1.src = "http://cez.aist-agro.ru/image/Pic40.png";
	var q2 = document.getElementById('p2'); q2.src = "http://cez.aist-agro.ru/image/Pic52.png";
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic63.png";
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic70.png";
	t = document.getElementById('nl');t.innerHTML = 'Технологии';
	
	t = document.getElementById('Pi');t.innerHTML = '<img src="http://cez.aist-agro.ru/image/Ti02.png" id="tf0" width="205" height="37" onclick="fn100c(this)" onmouseover="fn100a(this)" onmouseout="fn100b(this)"/><img src="http://cez.aist-agro.ru/image/Ti10.png" id="tf1" width="205" height="37" onclick="fn110c(this)" onmouseover="fn110a(this)" onmouseout="fn110b(this)"/><img src="http://cez.aist-agro.ru/image/Ti20.png" id="tf2" width="205" height="37" onclick="fn120c(this)" onmouseover="fn120a(this)" onmouseout="fn120b(this)"/><img src="http://cez.aist-agro.ru/image/Ti30.png" id="tf3" width="205" height="37" onclick="fn130c(this)" onmouseover="fn130a(this)" onmouseout="fn130b(this)"/><img src="http://cez.aist-agro.ru/image/Ti40.png" id="tf4" width="205" height="37" onclick="fn140c(this)" onmouseover="fn140a(this)" onmouseout="fn140b(this)"/><img src="http://cez.aist-agro.ru/image/Ti50.png" id="tf5" width="205" height="37" onclick="fn150c(this)" onmouseover="fn150a(this)" onmouseout="fn150b(this)"/><img src="http://cez.aist-agro.ru/image/Ti60.png" id="tf6" width="205" height="37" onclick="fn160c(this)" onmouseover="fn160a(this)" onmouseout="fn160b(this)"/>'; //Кнопки левая панель

	//var u = document.getElementById('u');u.innerHTML = '<table id="menu" width="100%" border="0" cellpadding="0" cellspacing="0" style="height:24px"><tr><td id="menu1" style="background-image:url(http://cez.aist-agro.ru/image/menu.png); width:186px; height:24px"><img id="w1" src="http://cez.aist-agro.ru/image/j0.png" title="Загрузить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 20px" onmouseover="fp1a(this)" onmouseout="fp1b(this)" onclick="fp1c(this)"/><img id="w2" src="http://cez.aist-agro.ru/image/j1.png"  title="Расчитать технологию" width="23px" height="22px" style="margin: 0px 0px 0px 7px" onmouseover="fp2a(this)" onmouseout="fp2b(this)" onclick="fp2c(this)"/><img id="w3" src="http://cez.aist-agro.ru/image/j2.png" title="Очистить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 9px" onmouseover="fp3a(this)" onmouseout="fp3b(this)" onclick="fp3c(this)"/><img id="w4" src="http://cez.aist-agro.ru/image/j3.png" title="Передать технологию на печать" width="23px" height="22px" style="margin: 0px 0px 0px 10px"  onmouseover="fp4a(this)" onmouseout="fp4b(this)" onclick="fp4c(this)"/><img id="w5" src="http://cez.aist-agro.ru/image/j4.png" title="Сохранить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 11px" onmouseover="fp5a(this)" onmouseout="fp5b(this)" onclick="fp5c(this)"/></td><td id="menu2" align="left" style="height:24px; margin-left:5px"><input id="b2" type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pl0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)"/><input type="button" value="Технология 1" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp3.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 2" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 3" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 4" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 5" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Cr0.png); width:26px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pcr()"/><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pr0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)"/></td></tr></table><p style="padding: 0pt 9pt 0pt 33pt; ">Операционная матрица технологий</p><div id="tn" style="background-image:url(http://cez.aist-agro.ru/image/pnt.png); height:30pt; padding-top:35pt"><table width="761pt" style="border-collapse: collapse; margin-left:6pt" cellpadding="0" cellspacing="0" border="0"><tr><td width="363"><input type="text" id="tx1" style="border-style:hidden; margin:2pt 0pt 0pt 9pt; width:348px; height:15px"/></td><td width="167"><select id="tx2" style="margin:0pt 0pt 0pt 4pt; width:165px" ></select></td><td width="103"><input type="text" id="tx3" style="border-style:hidden; margin:2pt 0pt 0pt 5pt; width:87px; height:15px"/></td><td width="97"><input type="text" id="tx4" style="border-style:hidden; margin:2pt 0pt 0pt 7pt; width:85px; height:15px"/></td></tr></table></div><div id="qt" style="margin: 0px 10px 10px 10px; height:531px; width:766px; display:block; overflow:auto"><table id="Q1" width="1550px" class="MsoNormal" style="border-collapse: collapse; border-color:rgb(204,204,204); font-size:9.0pt; font-family:Microsoft Sans Serif" border="1"><tbody><tr height="30px" style="background-image:url(http://cez.aist-agro.ru/image/tbgz.png);"><td width="30px" align="center"></td><td width="25px" align="center">№</td><td width="250" align="center">Операция</td><td width="74" align="center">Год</td><td width="74" align="center">Дни</td><td width="74" align="center">Часы</td><td width="248" align="center">Исходные требования</td><td width="150" align="center">Тип техники</td><td width="120" align="center">Энергосредство</td><td width="20" align="center">№</td><td width="120" align="center">Машина 2</td><td width="20" align="center">№</td><td width="120" align="center">Машина 3</td><td width="20" align="center">№</td><td width="120" align="center">Машина 4</td><td width="20" align="center">№</td><td width="120" align="center">Машина 5</td><td width="20" align="center">№</td></tr><tr height="27px" align="center" onmousedown="selectrow(this)"><td id="ctm" style="background-image:url(http://cez.aist-agro.ru/image/Aq3.png)" onclick="taddrow(this)"></td><td>44</td><td align="left"><input style=" width:242px; height:16px; border-width:0" /></td><td><select style="width:71px"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" /></td><td><input style="width:142px; height:16px; border-width:0" /></td><td onclick="jk(this)">Энергосредство</td><td></td><td onclick="jk(this)">Машина 1</td><td></td><td onclick="jk(this)">Машина 2</td><td></td><td onclick="jk(this)">Машина 3</td><td></td><td onclick="jk(this)">Машина 4</td><td></td></tr></tbody></table></div>'; //Основное рабочее пространство

	var u = document.getElementById('u');u.innerHTML = '<table id="menu" width="100%" border="0" cellpadding="0" cellspacing="0" style="height:24px"><tr><td id="menu1" style="background-image:url(http://cez.aist-agro.ru/image/menu.png); width:186px; height:24px"><img id="w1" class="cursor" src="http://cez.aist-agro.ru/image/j0.png" title="Загрузить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 20px" onmouseover="fp1a(this)" onmouseout="fp1b(this)" onclick="fp1c(this)"/><img id="w2" class="cursor" src="http://cez.aist-agro.ru/image/j1.png"  title="Расчитать технологию" width="23px" height="22px" style="margin: 0px 0px 0px 7px" onmouseover="fp2a(this)" onmouseout="fp2b(this)" onclick="fp2c(this)"/><img id="w3" class="cursor" src="http://cez.aist-agro.ru/image/j2.png" title="Очистить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 9px" onmouseover="fp3a(this)" onmouseout="fp3b(this)" onclick="fp3c(this)"/><span rel="#adjust-settings" class="modal-link"><span><img id="w4" src="http://cez.aist-agro.ru/image/j3.png" title="Передать технологию на печать" width="23px" height="22px" style="margin: 0px 0px 0px 10px"  onmouseover="fp4a(this)" onmouseout="fp4b(this)" onclick="fp4c(this)"/></span></span><img id="w5" class="cursor" src="http://cez.aist-agro.ru/image/j4.png" title="Сохранить технологию" width="23px" height="22px" style="margin: 0px 0px 0px 11px" onmouseover="fp5a(this)" onmouseout="fp5b(this)" onclick="fp5c(this)"/></td><td id="menu2" align="left" style="height:24px; margin-left:5px"><input id="b2" type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pl0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)"/><input type="button" value="Технология 1" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp3.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 2" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 3" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 4" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="Технология 5" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left"/><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Cr0.png); width:26px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pcr()"/><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pr0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)"/></td></tr></table><p style="padding: 0pt 9pt 0pt 33pt; ">Операционная матрица технологий</p><div id="tn" style="background-image:url(http://cez.aist-agro.ru/image/pnt.png); height:30pt; padding-top:35pt"><table width="761pt" style="border-collapse: collapse; margin-left:6pt" cellpadding="0" cellspacing="0" border="0"><tr><td width="363"><input type="text" id="tx1" style="border-style:hidden; margin:1pt 0pt 0pt 9pt; width:348px; height:15px" onchange="ret()"/></td><td width="167" style="padding-left:5px"><div id="sorta"><select id="tx2" style="width:173px" class="chzn-select" onchange="chng()" size="11"></select></div></td><td width="103"><input type="text" id="tx3" style="border-style:hidden; margin:1pt 0pt 0pt 5pt; width:87px; height:15px" onchange="ret()"/></td><td width="97"><input type="text" id="tx4" style="border-style:hidden; margin:1pt 0pt 0pt 7pt; width:85px; height:15px" onchange="ret()"/></td></tr></table></div><div id="qt" style="margin: 0px 10px 10px 10px; height:531px; width:766px; display:block; overflow:auto"><table id="Q1" width="1550px" class="MsoNormal" style="border-collapse: collapse; border-color:rgb(204,204,204); font-size:9.0pt; font-family:Microsoft Sans Serif" border="1"><tbody><tr height="30px" style="background-image:url(http://cez.aist-agro.ru/image/tbgz.png);"><td width="30px" align="center"></td><td width="25px" align="center">№</td><td width="250" align="center">Операция</td><td width="74" align="center">Год</td><td width="74" align="center">Дни</td><td width="74" align="center">Часы</td><td width="248" align="center">Исходные требования</td><td width="150" align="center">Тип техники</td><td width="120" align="center">Энергосредство</td><td width="20" align="center">№</td><td width="120" align="center">Машина 2</td><td width="20" align="center">№</td><td width="120" align="center">Машина 3</td><td width="20" align="center">№</td><td width="120" align="center">Машина 4</td><td width="20" align="center">№</td><td width="120" align="center">Машина 5</td><td width="20" align="center">№</td></tr><tr height="27px" align="center" onmousedown="selectrow(this)"><td style="background-image:url(http://cez.aist-agro.ru/image/Aq3.png)" onclick="taddrow(this)" onmouseup="mup(this)"></td><td>1</td><td align="left"><input style=" width:242px; height:16px; border-width:0"  onchange="ret()" /></td><td><select style="width:71px" onchange="ret()"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" onchange="ret()" /></td><td><input style="width:142px; height:16px; border-width:0" onchange="ret()" /></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td></tr></tbody></table></div>'; //Основное рабочее пространство
...
function Pic7(e){
	...
	var q1 = document.getElementById('p1');if(q1.src == 'http://cez.aist-agro.ru/image/Pic42.png'){t = document.getElementById('u');pc5 = t.innerHTML;};q1.src = "http://cez.aist-agro.ru/image/Pic40.png";
	var q2 = document.getElementById('p2');if(q2.src == 'http://cez.aist-agro.ru/image/Pic52.png'){t = document.getElementById('u');pc6 = t.innerHTML;}; q2.src = "http://cez.aist-agro.ru/image/Pic50.png";
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic62.png";
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic73.png";
...
function Pic8(e){
	...
	var q2 = document.getElementById('p2');if(q2.src == 'http://cez.aist-agro.ru/image/Pic52.png'){t = document.getElementById('u');pc6 = t.innerHTML;}; q2.src = "http://cez.aist-agro.ru/image/Pic50.png";
	var q3 = document.getElementById('p3'); q3.src = "http://cez.aist-agro.ru/image/Pic60.png";
	var q4 = document.getElementById('p4'); q4.src = "http://cez.aist-agro.ru/image/Pic72.png";
		...
		if(k3 == false){
			...
			if(k0.indexOf(t.value) > -1 && t.value != ''){
				if(k2.innerHTML.indexOf('mse.png') > -1){
					document.getElementById('Op60').innerHTML = '<label for="Op6">Исходные требования</label><select id="Op6" style="width:361px" onchange="fOp6()"><option></option></select><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mse.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/><label for="Op7" style="margin-top:10px">Материалы</label><input id="Op7" type="text" style="width:165px; margin-top:10px" placeholder="Пример: Нитроаммофоска"/><input id="Op8" type="text" style="width:70px; margin-left:10px; margin-top:10px" placeholder="кг на 1Га"/><input id="Op9" type="text" style="width:70px; margin-left:10px; margin-top:10px" placeholder="руб. за 1 кг"/>';
				}
				else{
					document.getElementById('Op60').innerHTML = '<label for="Op6">Исходные требования</label><input id="Op6" type="text" /><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mss.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/><label for="Op7" style="margin-top:10px">Материалы</label><input id="Op7" type="text" style="width:165px; margin-top:10px" placeholder="Пример: Нитроаммофоска"/><input id="Op8" type="text" style="width:70px; margin-left:10px; margin-top:10px" placeholder="кг на 1Га"/><input id="Op9" type="text" style="width:70px; margin-left:10px; margin-top:10px" placeholder="руб. за 1 кг"/>';
				}
			}
			else{
				if(k2.innerHTML.indexOf('mse.png') > -1){
					document.getElementById('Op60').innerHTML = '<label for="Op6">Исходные требования</label><select id="Op6" style="width:361px" onchange="fOp6()"><option></option></select><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mse.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/>';
				}
				else{
					document.getElementById('Op60').innerHTML = '<label for="Op6">Исходные требования</label><input id="Op6" type="text" /><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mss.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/>';
				}
			}
		}
		if(k3 == true){
...
function msb11(){
	document.getElementById('msb1').src = "http://cez.aist-agro.ru/image/master/msk31.png";
}
function msb10(){
	document.getElementById('msb1').src = "http://cez.aist-agro.ru/image/master/msk30.png";
}
function msb21(){
	document.getElementById('msb2').src = "http://cez.aist-agro.ru/image/master/msk21.png";
}
function msb20(){
	document.getElementById('msb2').src = "http://cez.aist-agro.ru/image/master/msk20.png";
}
function msb31(){
	document.getElementById('msb3').src = "http://cez.aist-agro.ru/image/master/msk11.png";
}
function msb30(){
	document.getElementById('msb3').src = "http://cez.aist-agro.ru/image/master/msk10.png";
}
function msb41(){
	document.getElementById('msb4').src = "http://cez.aist-agro.ru/image/master/msb41.png";
}
function msb40(){
	document.getElementById('msb4').src = "http://cez.aist-agro.ru/image/master/msb40.png";
}
function msb51(){
	document.getElementById('msb5').src = "http://cez.aist-agro.ru/image/master/msb51.png";
}
function msb50(){
	document.getElementById('msb5').src = "http://cez.aist-agro.ru/image/master/msb50.png";
}
function msb61(){
	document.getElementById('msb6').src = "http://cez.aist-agro.ru/image/master/msb61.png";
}
function msb60(){
	document.getElementById('msb6').src = "http://cez.aist-agro.ru/image/master/msb60.png";
...
function msit(){
	...
	if(t.innerHTML.indexOf('Исходные требования</label><input') > -1){
		t.innerHTML = '<label for="Op6">Исходные требования</label><select id="Op6" style="width:361px" onchange="fOp6()"><option></option></select><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mse.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/>';
		msqx();
		fOp2();
	}
	else{
		t.innerHTML = '<label for="Op6">Исходные требования</label><input id="Op6" type="text" /><img id="Op61" class="cursor" src="http://cez.aist-agro.ru/image/master/mss.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msit()"/>';
		msqx();
	}
...
function msop(){
	...
	if(t.innerHTML.indexOf('<input') > -1){
		t.innerHTML = '<label for="Op2">Операция</label><select id="Op2" style="width:361px" onchange="fOp2()"><option></option></select><img id="Op21" class="cursor" src="http://cez.aist-agro.ru/image/master/mse.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msop()">';
		msqx();
		fOp1();
	}
	else{
		if(document.getElementById('Op1').value != ''){
			t.innerHTML = '<label for="Op2">Операция</label><input id="Op2" type="text" /><img id="Op21" class="cursor" src="http://cez.aist-agro.ru/image/master/mss.png" style="margin-left:13px; margin-top:3px" width="20px" height="20px" onclick="msop()">';
			msqx();
			fOp2();
		}
		else{
...
function ftm1(){
	var q1 = document.getElementById('tm1'); q1.src = "http://cez.aist-agro.ru/image/master/tmn2.png";
	var q2 = document.getElementById('tm2'); q2.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
	var q3 = document.getElementById('tm3'); q3.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
	
	Mls('t');
} // Операции Традиционная технология рисунок
function ftm2(){
	var q1 = document.getElementById('tm1'); q1.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
	var q2 = document.getElementById('tm2'); q2.src = "http://cez.aist-agro.ru/image/master/tmn2.png";
	var q3 = document.getElementById('tm3'); q3.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
...
function ftm3(){
	var q1 = document.getElementById('tm1'); q1.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
	var q2 = document.getElementById('tm2'); q2.src = "http://cez.aist-agro.ru/image/master/tmn1.png";
	var q3 = document.getElementById('tm3'); q3.src = "http://cez.aist-agro.ru/image/master/tmn2.png";
...
function frm(){
	window.open('http://cez.aist-agro.ru/forum/index.php', '', '', true);
} //Кнопачка Форум
...
function tload(){
	...
	document.getElementById('u').innerHTML = '<img src="http://cez.aist-agro.ru/image/mnu.png" width="787" height="24"/><p style="padding: 0pt 9pt 0pt 33pt; ">Выбор технологии</p><div id="tload" style="margin-left:10px; height:617px; width:768px"><table width="768px" height="620px" border="1" cellpadding="0" cellspacing="0" style="border-collapse:collapse"><tr height="29px" style="background-image:url(http://cez.aist-agro.ru/image/tbgz.png)"><td colspan="2"><table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="font-size:12px; font-family:Microsoft Sans Serif; border-collapse:collapse"><tr><td width="257px" align="left" style="padding-left:15px">Выбор культуры</td><td width="458px" align="left" style="padding-left:15px">Выбор технологии</td><td width="50px"><img class="cursor" src="http://cez.aist-agro.ru/image/btn21.png" width="36" height="15" style="margin-left:5px; margin-top:2px" onmouseover="ft01(this)" onmouseout="ft02(this)" onclick="tehs()"/></td></tr></table></td></tr><tr><td width="250px"  valign="top" style="padding-top:10px;padding-left:7px"><div id="tree" style="height:569px; width:243px; overflow-y:scroll; display:block;"></div></td><td width="515px" valign="top"><table width="515" border="1" cellpadding="0" cellspacing="0" style="font-size:12px; font-family:Microsoft Sans Serif; border-collapse:collapse"><tr height="25px"  style="background-image:url(http://cez.aist-agro.ru/image/shp.png)"><td width="25px" align="center">№</td><td width="100px" align="center">Шифр</td><td width="390px" align="center">Наименование технологии</td></tr></table><div style="width:515px; display:block; height:553px; overflow-y:scroll;"><table id="teh" width="495" border="1" cellpadding="0" cellspacing="0" style="font-size:12px; font-family:Microsoft Sans Serif; border-collapse:collapse"></table></div></td></tr></table></div>';
...
function zl1(d){
	if(tsv[0].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[0] + '`' + uin + '`' + tsvz), zl2);
	}
	else{
...
function zl2(d){
	if(tsv[1].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[1] + '`' + uin + '`' + tsvz), zl3);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = ''; 
	}
...
function zl3(d){
	if(tsv[2].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[2] + '`' + uin + '`' + tsvz), zl4);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl4(d){
	if(tsv[3].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[3] + '`' + uin + '`' + tsvz), zl5);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl5(d){
	if(tsv[4].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[4] + '`' + uin + '`' + tsvz), zl6);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl6(d){
	if(tsv[5].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[5] + '`' + uin + '`' + tsvz), zl7);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl7(d){
	if(tsv[6].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[6] + '`' + uin + '`' + tsvz), zl8);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl8(d){
	if(tsv[7].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[7] + '`' + uin + '`' + tsvz), zl9);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl9(d){
	if(tsv[8].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[8] + '`' + uin + '`' + tsvz), zl10);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl10(d){
	if(tsv[9].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[9] + '`' + uin + '`' + tsvz), zl11);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl11(d){
	if(tsv[10].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[10] + '`' + uin + '`' + tsvz), zl12);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl12(d){
	if(tsv[11].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[11] + '`' + uin + '`' + tsvz), zl13);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl13(d){
	if(tsv[12].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[12] + '`' + uin + '`' + tsvz), zl14);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl14(d){
	if(tsv[13].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[13] + '`' + uin + '`' + tsvz), zl15);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function zl15(d){
	if(tsv[14].length > 0){
		getAjax('http://cez.aist-agro.ru/itks.php?s=' + encodeURIComponent(tsv[14] + '`' + uin + '`' + tsvz), esc);
	}
	else{
		tsv = new Array(); tsvz = ''; tsvg = '';
	}
...
function exm(){
	...
	if(document.getElementById('Q2') != null){
		...
		for(var i = 1; i < a2.length; i++){//alert(a2[i][2]);
			...
			else if(a2[i][2].indexOf('Минеральные') > -1 && i == 2){a[i] = '<tr height="27px" align="center" onmousedown="srQ2(this)"><td style="background-image:url(http://cez.aist-agro.ru/image/Aq.png)"  onmousedown="mdQ2(this)" onmouseup="muQ2(this)"></td><td>2</td><td align="left" style="text-indent: 7.0pt">Минеральные удобрения</td><td></td><td></td></tr>';}
			else if(a2[i][2].indexOf('средства защиты растений') > -1){a[i] = '<tr height="27px" align="center" onmousedown="srQ2(this)"><td style="background-image:url(http://cez.aist-agro.ru/image/Aq.png)" onmousedown="mdQ2(this)" onmouseup="muQ2(this)"></td><td>3</td><td align="left" style="text-indent: 7pt">Химические средства защиты растений</td><td></td><td></td></tr>';}
		...
		s = '<table id="Q2" width="766px" class="MsoNormal" style="border-collapse: collapse; border-color:rgb(204,204,204); font-size:9.0pt; font-family:Microsoft Sans Serif" border="1"><tr height="30px" style="background-image:url(http://cez.aist-agro.ru/image/tbgz.png);"><td width="25px" align="center"></td><td width="30px" align="center">№</td><td width="305px" align="center">Наименование</td><td width="203px" align="center">Количество (кг* на 1 Га)</td><td width="203px" align="center">Цена, руб. (за 1 кг)</td></tr>' + a.join('') + '</table>'
...
//Вкладки технологий
var psg = '<input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pl0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pm(1)"><input type="button" value="Технология 1" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp3.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)"><input type="button" value="Технология 2" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)"><input type="button" value="Технология 3" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)"><input type="button" value="Технология 4" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)"><input type="button" value="Технология 5" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)"><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Cr0.png); width:26px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pcr()"><input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pr0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pm(2)">'; //Переменная хранения панели вкладок
var ps = new Array(['<input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pl0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pm(1)">'],['<input type="button" value="Технология 1" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp3.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'],['<input type="button" value="Технология 2" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'],['<input type="button" value="Технология 3" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'],['<input type="button" value="Технология 4" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'],['<input type="button" value="Технология 5" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'],['<input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Cr0.png); width:26px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pcr()">'],['<input type="button" value="." style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pr0.png); width:20px; height:24px; font-size:10px; color:rgba(255,255,255,0)" onclick="pm(2)">']);	//Массив вкладок технологий
function psn(){
...
function pcr(){//par(document.getElementById('menu2').innerHTML);//формирование массива вкладок
	...
	ps[ps.length] = '<input type="button" value="Технология" style="border-style:hidden; background-image:url(http://cez.aist-agro.ru/image/Pbp0.png); width:107px; height:24px; font-size:10px; text-align:left" onclick="psel(this)" onmousemove="pmv(this,event)" onmouseout="pmo(this)">'.replace('Технология', 'Технология ' + parseInt(ps.length)); ps[ps.length] = sc; ps[ps.length] = sr;
	pm(2);
...
function pmv(o,e){var x = e.offsetX; var y = e.offsetY
	...
	if(x > 80){//alert(o.style.backgroundImage);
		...
		{o.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Pbp02.png")';
		if(brw == 'gc'){o.style.backgroundImage = 'url(http://cez.aist-agro.ru/image/Pbp02.png)';}
		}
		else if(o.style.backgroundImage.indexOf('Pbp3') > 0)
		{o.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Pbp4.png")'
		if(brw == 'gc'){o.style.backgroundImage = 'url(http://cez.aist-agro.ru/image/Pbp4.png)';}
		}
	}
	else{pmo(o)}
...
function pmo(o){//alert(123);
	...
	{o.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Pbp0.png")';
	if(brw == 'gc'){o.style.backgroundImage = 'url(http://cez.aist-agro.ru/image/Pbp0.png)';}
	}
	else if(o.style.backgroundImage.indexOf('Pbp4') > 0)
	{o.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Pbp3.png")';
	if(brw == 'gc'){o.style.backgroundImage = 'url(http://cez.aist-agro.ru/image/Pbp3.png)';}
	}
	...
	if(document.getElementById('Q1') != null){var q = document.getElementById('Q1');
		...
		for(var i = 1; i < q.rows.length; i++){
			if(q.rows[i].style.backgroundColor.indexOf('173') > 0){
				...
				if(q.rows.length < 2){document.getElementById('qt').innerHTML = '<table id="Q1" width="1550px" class="MsoNormal" style="border-collapse: collapse; border-color:rgb(204,204,204); font-size:9.0pt; font-family:Microsoft Sans Serif" border="1"><tbody><tr height="30px" style="background-image:url(http://cez.aist-agro.ru/image/tbgz.png);"><td width="30px" align="center"></td><td width="25px" align="center">№</td><td width="250" align="center">Операция</td><td width="74" align="center">Год</td><td width="74" align="center">Дни</td><td width="74" align="center">Часы</td><td width="248" align="center">Исходные требования</td><td width="150" align="center">Тип техники</td><td width="120" align="center">Энергосредство</td><td width="20" align="center">№</td><td width="120" align="center">Машина 2</td><td width="20" align="center">№</td><td width="120" align="center">Машина 3</td><td width="20" align="center">№</td><td width="120" align="center">Машина 4</td><td width="20" align="center">№</td><td width="120" align="center">Машина 5</td><td width="20" align="center">№</td></tr><tr height="27px" align="center" onmousedown="selectrow(this)"><td id="ctm" style="background-image:url(http://cez.aist-agro.ru/image/Aq3.png)" onclick="taddrow(this)"></td><td>1</td><td align="left"><input style=" width:242px; height:16px; border-width:0" onchange="ret()"/></td><td><select style="width:71px" onchange="ret()"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" onchange="ret()"/></td><td><input style="width:142px; height:16px; border-width:0" onchange="ret()"/></td><td onclick="jk(this)"></td><td></td><td onclick="jk(this)"></td><td></td><td onclick="jk(this)"></td><td></td><td onclick="jk(this)"></td><td></td><td onclick="jk(this)"></td><td></td></tr></tbody></table>';}
			}
		}
		...
		q.rows[i-1].cells[0].style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Aq4.png")';
		ret();
	}
			...
			for(var k = 1; k < q.rows.length; k++){//alert(111);
				if(q.rows[k].innerHTML.indexOf('Aq2') > -1 || q.rows[k].innerHTML.indexOf('Aq3') > -1){//alert(123);
					...
					for(var i = a.length-1; i > -1; i--){m = a[i].split('$');
						...
						q.rows[k].innerHTML = '<td style="background-image:url(http://cez.aist-agro.ru/image/Aq2.png)"  onmouseup="mup(this)" onmousedown="mdown(this)"></td><td></td><td align="left"><input style=" width:242px; height:16px; border-width:0"  onchange="ret()" /></td><td><select style="width:71px" onchange="ret()"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" onchange="ret()" /></td><td><input style="width:142px; height:16px; border-width:0" onchange="ret()" /></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td>';
			...
			for(var k = 1; k < q.rows.length; k++){//alert(111);
				if(q.rows[k].innerHTML.indexOf('Aq2') > -1 || q.rows[k].innerHTML.indexOf('Aq3') > -1){//alert(123);
					for(var i = a.length-1; i > -1; i--){m = a[i].split('$');
						...
						q.rows[k].innerHTML = '<td style="background-image:url(http://cez.aist-agro.ru/image/Aq2.png)" onmousedown="mdQ2(this)" onmouseup="muQ2(this)"></td><td></td><td align="left"><input style=" width:280px; height:16px; border-width:0; margin-left: 7pt" /></td><td><input style=" width:170px; height:16px; border-width:0" /></td><td><input style=" width:170px; height:16px; border-width:0" /></td>';
						// Вставляем данные из буфера обмена
						q.rows[k].cells[2].firstChild.value = m[0];
	...
	if(document.getElementById('Q1') != null){var q = document.getElementById('Q1');
		for(var i = 1; i < q.rows.length; i++){
			if(q.rows[i].cells[0].style.backgroundImage.indexOf('Aq2') > 0 || q.rows[i].cells[0].style.backgroundImage.indexOf('Aq3') > 0){
				...
				q.rows[i].innerHTML = '<td style="background-image:url(http://cez.aist-agro.ru/image/Aq2.png)" onmousedown="mdown(this)" onmouseup="mup(this)"></td><td></td><td align="left"><input style=" width:242px; height:16px; border-width:0"  onchange="ret()" /></td><td><select style="width:71px" onchange="ret()"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" onchange="ret()" /></td><td><input style="width:142px; height:16px; border-width:0" onchange="ret()" /></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td>';
...
function maddrow(o){
	...
	t.rows[i].innerHTML = '<td style="background-image:url(http://cez.aist-agro.ru/image/Aq2.png)" onclick="maddrow(this)" onmouseup="muQ2(this)"></td><td>1</td><td align="left"><input style=" width:280px; height:16px; border-width:0; margin-left: 7pt" /></td><td><input style=" width:170px; height:16px; border-width:0" /></td><td><input style=" width:170px; height:16px; border-width:0" /></td>';
...
function zrQ2(){
	...
	for(var k = 1; k < document.getElementById('Q2').rows.length; k++)
	{
		...
		if(r.cells[0].style.backgroundImage == 'url("http://cez.aist-agro.ru/image/Aq2.png")')
		{r.cells[0].style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Aq.png")'}
	...
	r.cells[0].style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Aq4.png")';
	
	//Если Хром
	if(brw == 'gc'){r.cells[0].style.backgroundImage = 'url(http://cez.aist-agro.ru/image/Aq4.png)';}
...
function srQ2(o){var i = o.rowIndex;
	...
	if(i == R.length - 1){r.cells[0].style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Aq3.png")';}
	else{r.cells[0].style.backgroundImage = 'url("http://cez.aist-agro.ru/image/Aq2.png")';}
...
function taddrow(e){
	...
	t.rows[i].innerHTML = '<td style="background-image:url(http://cez.aist-agro.ru/image/Aq2.png)" onclick="taddrow(this)" onmouseup="mup(this)"></td><td></td><td align="left"><input style=" width:242px; height:16px; border-width:0"  onchange="ret()" /></td><td><select style="width:71px" onchange="ret()"><option></option><option>K</option><option>L</option><option>M</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><select style="width:71px" onchange="ret()"><option></option><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option><option>6</option><option>7</option><option>8</option><option>9</option><option>10</option><option>11</option><option>12</option><option>13</option><option>14</option><option>15</option><option>16</option><option>17</option><option>18</option><option>19</option><option>20</option><option>21</option><option>22</option><option>23</option><option>24</option></select></td><td><input style=" width:238px; height:16px; border-width:0" onchange="ret()" /></td><td><input style="width:142px; height:16px; border-width:0" onchange="ret()" /></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td><td class="cursor" onclick="jk(this)"></td><td></td>';
...
function fn00a(e){e.src = "http://cez.aist-agro.ru/image/Pi01.png"};function fn00b(e){e.src = "http://cez.aist-agro.ru/image/Pi00.png"};
function fn10a(e){e.src = "http://cez.aist-agro.ru/image/Pi11.png"};function fn10b(e){e.src = "http://cez.aist-agro.ru/image/Pi10.png"};
function fn20a(e){e.src = "http://cez.aist-agro.ru/image/Pi21.png"};function fn20b(e){e.src = "http://cez.aist-agro.ru/image/Pi20.png"}; //Ваще чот ни откуда функции...
function fn100a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti02.png"){e.src = "http://cez.aist-agro.ru/image/Ti01.png"}};
function fn100b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti02.png"){e.src = "http://cez.aist-agro.ru/image/Ti00.png"}};function fn100c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti02.png"; Q1();};//Операции
function fn110a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti12.png"){e.src = "http://cez.aist-agro.ru/image/Ti11.png"}};
function fn110b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti12.png"){e.src = "http://cez.aist-agro.ru/image/Ti10.png"}};function fn110c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti12.png"; Q2();};//Материалы
function fn120a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti22.png"){e.src = "http://cez.aist-agro.ru/image/Ti21.png"}};
function fn120b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti22.png"){e.src = "http://cez.aist-agro.ru/image/Ti20.png"}};function fn120c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti22.png"; Q3();trd();};//ИТК-1
function fn130a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti32.png"){e.src = "http://cez.aist-agro.ru/image/Ti31.png"}};
function fn130b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti32.png"){e.src = "http://cez.aist-agro.ru/image/Ti30.png"}};function fn130c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti32.png"; Q4();trd();};//ИТК-2
function fn140a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti42.png"){e.src = "http://cez.aist-agro.ru/image/Ti41.png"}};
function fn140b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti42.png"){e.src = "http://cez.aist-agro.ru/image/Ti40.png"}};function fn140c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti42.png"; Q5();trd();};//ИТК-3
function fn150a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti52.png"){e.src = "http://cez.aist-agro.ru/image/Ti51.png"}};
function fn150b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti52.png"){e.src = "http://cez.aist-agro.ru/image/Ti50.png"}};function fn150c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti52.png"; Q6();trd();};//ИТК-4
function fn160a(e){if(e.src != "http://cez.aist-agro.ru/image/Ti62.png"){e.src = "http://cez.aist-agro.ru/image/Ti61.png"}};
function fn160b(e){if(e.src != "http://cez.aist-agro.ru/image/Ti62.png"){e.src = "http://cez.aist-agro.ru/image/Ti60.png"}};function fn160c(e){tiz(); e.src = "http://cez.aist-agro.ru/image/Ti62.png"; Q7();trd();};//ИТК-5 //Функции левой панели //Функции ИТК
function tiz(){
	document.getElementById('tf0').src = "http://cez.aist-agro.ru/image/Ti00.png";
	document.getElementById('tf1').src = "http://cez.aist-agro.ru/image/Ti10.png";
	document.getElementById('tf2').src = "http://cez.aist-agro.ru/image/Ti20.png";
	document.getElementById('tf3').src = "http://cez.aist-agro.ru/image/Ti30.png";
	document.getElementById('tf4').src = "http://cez.aist-agro.ru/image/Ti40.png";
	document.getElementById('tf5').src = "http://cez.aist-agro.ru/image/Ti50.png";
	document.getElementById('tf6').src = "http://cez.aist-agro.ru/image/Ti60.png";
} //Обнуление изображений кнопок

//---------------------------------------------------------------------------------------------------------------------------

function fn200a(e){e.src = "http://cez.aist-agro.ru/image/Pi201.png"};function fn200b(e){e.src = "http://cez.aist-agro.ru/image/Pi200.png"};function fn210a(e){e.src = "http://cez.aist-agro.ru/image/Pi211.png"};function fn210b(e){e.src = "http://cez.aist-agro.ru/image/Pi210.png"}; //Группа смены изображений кнопок технологий
function fp1a(e){e.src = "http://cez.aist-agro.ru/image/j01.png"};function fp1b(e){e.src = "http://cez.aist-agro.ru/image/j0.png"};function fp1c(e){tload()};// Загрузить технологию alert(tv[ip()])
function fp2a(e){e.src = "http://cez.aist-agro.ru/image/j11.png"};function fp2b(e){e.src = "http://cez.aist-agro.ru/image/j1.png"};function fp2c(e){
...
function fp3a(e){e.src = "http://cez.aist-agro.ru/image/j21.png"};function fp3b(e){e.src = "http://cez.aist-agro.ru/image/j2.png"};function fp3c(e){tdel();};// Удалить технологию
function fp4a(e){e.src = "http://cez.aist-agro.ru/image/j31.png"};function fp4b(e){e.src = "http://cez.aist-agro.ru/image/j3.png"};function fp4c(e){thtml();};// Передать технологию в MS Word
function fp5a(e){e.src = "http://cez.aist-agro.ru/image/j41.png"};function fp5b(e){e.src = "http://cez.aist-agro.ru/image/j4.png"};function fp5c(e){tsave();};// Сохранить технологию  //Группа смены изображений кнопок панели инструментов
...
function jk(e){
	...
	t.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/fds.png")';
	t.style.paddingTop = "1pt";
	t.style.height = "64pt";
	t.innerHTML = '<img src="http://cez.aist-agro.ru/image/btn21.png" width="36" height="15" style="margin-left:735px; margin-top:12px" onmouseover="ft01(this)" onmouseout="ft02(this)" onclick="ft03()"/><table width="764pt" style="border-collapse: collapse; margin-left:6pt; margin-top:13pt" cellpadding="0" cellspacing="0" border="0"><tr height="25px"><td width="296"><select id="sp1" style="margin:1pt 0pt 0pt 7pt; width:301px" onchange="Cb1()"></select></td><td width="170"><select id="sp2" style="margin:1pt 0pt 0pt 1pt; width:166px" onchange="Cb2()"></select></td><td width="105"><select id="sp3" style="margin:1pt 0pt 0pt 1pt; width:101px"></select></td><td width="103"><select id="sp4" style="border-color:rgb(255,255,255); margin:1pt 0pt 0pt 1pt; width:101px"></select></td><td width="31"><img src="http://cez.aist-agro.ru/image/btn01.png"  width="24px" height="24px" style="margin: 0px 0px 0px 3px" onmouseover="ft11(this)" onmouseout="ft12(this)" onclick="ft13()"/></td><td width="27"><img src="http://cez.aist-agro.ru/image/btn11.png"  width="24px" height="24px" style="margin: 0px 0px 0px 1px" onmouseover="ft21(this)" onmouseout="ft22(this)" onclick="ft14()"/></td></tr></table>';
...
function ft01(e){e.src = "http://cez.aist-agro.ru/image/btn22.png"} //На наведение кусора мыши на кнопку закрыть в наборной панели машин
function ft02(e){e.src = "http://cez.aist-agro.ru/image/btn21.png"} //На отведение кусора мыши на кнопку закрыть в наборной панели машин
function ft11(e){e.src = "http://cez.aist-agro.ru/image/btn02.png"} //На наведение курсора мыши на удалить набранную машину
function ft12(e){e.src = "http://cez.aist-agro.ru/image/btn01.png"} //На отведение курсора мыши от удалить набранную машину
function ft21(e){e.src = "http://cez.aist-agro.ru/image/btn12.png"} //На наведение курсора мыши на передать
function ft22(e){e.src = "http://cez.aist-agro.ru/image/btn11.png"} //На отведение курсора мыши от передать
function ft13(){
...
function ft03(){
	var t = document.getElementById('tn');
	t.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/pnt.png")';
...
function DelRows(){
	tic();
	t = document.getElementById('Q');t.innerHTML = '';//<table width="670" style="border-collapse: collapse;border-color: rgb(242,242,241); margin: 5pt 0pt 0pt 7pt"cellpadding="0" cellspacing="0" border="1" ><tr height="30pt"style="background-image:url(http://cez.aist-agro.ru/image/tbg.png)"><td width="25" style="padding: 0pt 0pt 0pt 6pt">№</td><td style="font: Tahoma, Geneva, sans-serif; padding:0pt 0pt 0pt 6pt;" width="295pt">Название машины</td><td  align="center" width="80pt">Wэ, га/ч</td><td align="center" width="80pt">ГСМ, кг/га</td><td align="center" width="80pt">ЧЭЗ, руб./час</td><td align="center" width="80pt">Сс, руб./га</td></tr></table>';
...
function dn(){
	...
	if(r.style.backgroundImage == 'url("http://cez.aist-agro.ru/image/v1.png")'){
...
function arc(e){
	...
	if(e.style.backgroundImage == 'url("http://cez.aist-agro.ru/image/v1.png")'){e.style.backgroundImage = '';return}
	for(var i = 1; i < 7; i++){r = R[i];r.style.backgroundImage = '';}
	if(e.style.backgroundImage == ''){e.style.backgroundImage = 'url("http://cez.aist-agro.ru/image/v1.png")';}
...
function infl(){
	...
	if(r[0].indexOf('7.2') > -1){
		window.open("http://cez.aist-agro.ru/inf.php?re=" + document.getElementById('a5').value, "_blank");
	}
	else{
...
function fp(){
	document.getElementById('cp1').src = 'http://cez.aist-agro.ru/image/H12.png';
	document.getElementById('cp2').src = 'http://cez.aist-agro.ru/image/H22.png';
	document.getElementById('cp3').src = 'http://cez.aist-agro.ru/image/H22.png';
	document.getElementById('cp4').src = 'http://cez.aist-agro.ru/image/H22.png';
	document.getElementById('cp5').src = 'http://cez.aist-agro.ru/image/H22.png';
} //Функция назначения базовых изображений на вкладках параметров
function fp1(e){fp(); e.src='http://cez.aist-agro.ru/image/H13.png'; delp(); onil(cz[0]);}
function fp2(e){fp(); e.src='http://cez.aist-agro.ru/image/H23.png'; delp(); onil(cz[1]);}
function fp3(e){fp(); e.src='http://cez.aist-agro.ru/image/H23.png'; delp(); onil(cz[2]);}
function fp4(e){fp(); e.src='http://cez.aist-agro.ru/image/H23.png'; delp(); onil(cz[3]);}
function fp5(e){fp(); e.src='http://cez.aist-agro.ru/image/H23.png'; delp(); onil(cz[4]);} //Группа функций на клик по вкладкам агрегатов
function repar(){var s = ReOne()
	if(document.getElementById('cp1').src == 'http://cez.aist-agro.ru/image/H13.png'){cz[0] = s}
	if(document.getElementById('cp2').src == 'http://cez.aist-agro.ru/image/H23.png'){cz[1] = s}
	if(document.getElementById('cp3').src == 'http://cez.aist-agro.ru/image/H23.png'){cz[2] = s}
	if(document.getElementById('cp4').src == 'http://cez.aist-agro.ru/image/H23.png'){cz[3] = s}
	if(document.getElementById('cp5').src == 'http://cez.aist-agro.ru/image/H23.png'){cz[4] = s};//alert(cz[0]);
...
function nechez(){
	...
	else if(document.getElementById('mychez').id != ''){
...
function tic(){
	//var s = '1.2\\Трактор К-3180\\К-3180\\180\\3\\1876992\\16000\\80\\1\\27.9\\0\\0\\0\\1\\10\\17\\122.1\\10\\5\\0.85\\0.8\\1.2\\05.10.2012';
	var s = '1.2\Трактор К-3180\К-3180\180\3\1876992\16000\80\1\27.9\0\0\0\1\10\17\122.1\10\5\0.85\0.8\1.2\05.10.2012';
	alert(ci(s));
}

function ci(s){//alert(s);
	if(s.split('\\').length > 5){
		getAjax("php/ai.php?s="+encodeURIComponent(s), ci);
	}
	else{
		return s;	
	}
...
function f00a(e){e.src = "http://cez.aist-agro.ru/image/Pi01.png"};function f00b(e){e.src = "http://cez.aist-agro.ru/image/Pi00.png"};
function f10a(e){e.src = "http://cez.aist-agro.ru/image/Pi11.png"};function f10b(e){e.src = "http://cez.aist-agro.ru/image/Pi10.png"};
function f20a(e){e.src = "http://cez.aist-agro.ru/image/Pi21.png"};function f20b(e){e.src = "http://cez.aist-agro.ru/image/Pi20.png"};

function f100a(e){e.src = "http://cez.aist-agro.ru/image/Pi101.png"};function f100b(e){e.src = "http://cez.aist-agro.ru/image/Pi100.png"};function f110a(e){e.src = "http://cez.aist-agro.ru/image/Pi111.png"};function f110b(e){e.src = "http://cez.aist-agro.ru/image/Pi110.png"};function f120a(e){e.src = "http://cez.aist-agro.ru/image/Pi121.png"};function f120b(e){e.src = "http://cez.aist-agro.ru/image/Pi120.png"};function f130a(e){e.src = "http://cez.aist-agro.ru/image/Pi131.png"};function f130b(e){e.src = "http://cez.aist-agro.ru/image/Pi130.png"};function f140a(e){e.src = "http://cez.aist-agro.ru/image/Pi141.png"};function f140b(e){e.src = "http://cez.aist-agro.ru/image/Pi140.png"};

function f200a(e){e.src = "http://cez.aist-agro.ru/image/Pi201.png"};function f200b(e){e.src = "http://cez.aist-agro.ru/image/Pi200.png"};function f210a(e){e.src = "http://cez.aist-agro.ru/image/Pi211.png"};function f210b(e){e.src = "http://cez.aist-agro.ru/image/Pi210.png"} // Группа смены кнопок функций
...
function fni(){
	//var inf = 
	window.open("http://cez.aist-agro.ru/tst.php", "_blank");
